...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Settlement.banker'
        db.add_column('alpha_settlement', 'banker', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['alpha.Person']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Settlement.banker'
        db.delete_column('alpha_settlement', 'banker_id')
    ...
    models = {
        'alpha.alert': {
            ...
            'parent_alert': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'child_alerts'", 'null': 'True', 'to': "orm['alpha.Alert']"}),
        ...
        'alpha.hmchatter': {
            ...
            'house': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['alpha.House']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'child_set'", 'null': 'True', 'to': "orm['alpha.HMChatter']"}),
            ...
            'transaction_parent': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'transaction_child_set'", 'null': 'True', 'to': "orm['alpha.HMTransaction']"})
        },
        'alpha.hmcreator': {
        ...
        'alpha.houseavatar': {
            'Meta': {'object_name': 'HouseAvatar'},
            'crop_from': ('django.db.models.fields.CharField', [], {'default': "'center'", 'max_length': '10', 'blank': 'True'}),
            'date_taken': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'effect': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'houseavatar_related'", 'null': 'True', 'to': "orm['photologue.PhotoEffect']"}),
            'house': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'avatar'", 'unique': 'True', 'primary_key': 'True', 'to': "orm['alpha.House']"}),
        ...
        'alpha.notification': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'origin': ('django.db.models.fields.CharField', [], {'max_length': '16'}),
            'person': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['alpha.Person']", 'blank': 'True'}),
            'template_path': ('django.db.models.fields.CharField', [], {'default': "'test_notification.html'", 'max_length': '100'}),
            'template_short_path': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'})
        },
        'alpha.person': {
        ...
        'alpha.personavatar': {
            ...
            'crop_from': ('django.db.models.fields.CharField', [], {'default': "'center'", 'max_length': '10', 'blank': 'True'}),
            'date_taken': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'effect': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'personavatar_related'", 'null': 'True', 'to': "orm['photologue.PhotoEffect']"}),
            'image': ('django.db.models.fields.files.ImageField', [], {'max_length': '100'}),
        ...
        'alpha.settlement': {
            ...
            'banker': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['alpha.Person']"}),
            'hmtransaction_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['alpha.HMTransaction']", 'unique': 'True', 'primary_key': 'True'}),
            'payer': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'old_payer'", 'to': "orm['alpha.Person']"})
        },
