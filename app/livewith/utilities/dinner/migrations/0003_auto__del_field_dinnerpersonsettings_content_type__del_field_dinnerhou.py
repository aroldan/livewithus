...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'DinnerPersonSettings.content_type'
        db.delete_column('dinner_dinnerpersonsettings', 'content_type_id')

        # Deleting field 'DinnerHouseSettings.content_type'
        db.delete_column('dinner_dinnerhousesettings', 'content_type_id')


    def backwards(self, orm):
        
        # Adding field 'DinnerPersonSettings.content_type'
        db.add_column('dinner_dinnerpersonsettings', 'content_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'], null=True), keep_default=False)

        # Adding field 'DinnerHouseSettings.content_type'
        db.add_column('dinner_dinnerhousesettings', 'content_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'], null=True), keep_default=False)
