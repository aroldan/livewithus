...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'DinnerPoll'
        db.create_table('dinner_dinnerpoll', (
            ('hmchatter_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['alpha.HMChatter'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('dinner', ['DinnerPoll'])

        # Adding model 'DinnerOption'
        db.create_table('dinner_dinneroption', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('dinner_poll', self.gf('django.db.models.fields.related.ForeignKey')(related_name='option_set', to=orm['dinner.DinnerPoll'])),
            ('option_text', self.gf('django.db.models.fields.CharField')(max_length=140)),
        ))
        db.send_create_signal('dinner', ['DinnerOption'])

        # Adding model 'DinnerResponse'
        db.create_table('dinner_dinnerresponse', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('person', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['alpha.Person'])),
            ('time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('vote', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dinner.DinnerOption'])),
        ))
        db.send_create_signal('dinner', ['DinnerResponse'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'DinnerPoll'
        db.delete_table('dinner_dinnerpoll')

        # Deleting model 'DinnerOption'
        db.delete_table('dinner_dinneroption')

        # Deleting model 'DinnerResponse'
        db.delete_table('dinner_dinnerresponse')
    ...
    models = {
        ...
        'dinner.housesettings': {
            'Meta': {'object_name': 'HouseSettings', '_ormbases': ['utilities.UtilityHouseSettings']},
        ...
        'dinner.personsettings': {
            'Meta': {'object_name': 'PersonSettings', '_ormbases': ['utilities.UtilityPersonSettings']},
