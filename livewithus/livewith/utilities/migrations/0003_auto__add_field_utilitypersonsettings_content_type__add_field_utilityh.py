...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UtilityPersonSettings.content_type'
        db.add_column('utilities_utilitypersonsettings', 'content_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'], null=True), keep_default=False)

        # Adding field 'UtilityHouseSettings.content_type'
        db.add_column('utilities_utilityhousesettings', 'content_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'], null=True), keep_default=False)

        # Adding field 'HMUtility.summary_template'
        db.add_column('utilities_hmutility', 'summary_template', self.gf('django.db.models.fields.CharField')(default='', max_length=200), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UtilityPersonSettings.content_type'
        db.delete_column('utilities_utilitypersonsettings', 'content_type_id')

        # Deleting field 'UtilityHouseSettings.content_type'
        db.delete_column('utilities_utilityhousesettings', 'content_type_id')

        # Deleting field 'HMUtility.summary_template'
        db.delete_column('utilities_hmutility', 'summary_template')
    ...
    models = {
        ...
        'utilities.hmutility': {
            ...
            'summary_template': ('django.db.models.fields.CharField', [], {'max_length': '200'})
        },
