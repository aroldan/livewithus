...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserPreferences.cell_provider'
        db.add_column('alpha_userpreferences', 'cell_provider', self.gf('django.db.models.fields.CharField')(default='O', max_length=1), keep_default=False)

        # Adding field 'UserPreferences.phoneNumber'
        db.add_column('alpha_userpreferences', 'phoneNumber', self.gf('django.db.models.fields.CharField')(default='', max_length=10, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserPreferences.cell_provider'
        db.delete_column('alpha_userpreferences', 'cell_provider')

        # Deleting field 'UserPreferences.phoneNumber'
        db.delete_column('alpha_userpreferences', 'phoneNumber')
