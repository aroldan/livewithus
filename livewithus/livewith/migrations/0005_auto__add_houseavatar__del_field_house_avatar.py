...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'HouseAvatar'
        db.create_table('alpha_houseavatar', (
            ...
            ('effect', self.gf('django.db.models.fields.related.ForeignKey')(related_name='houseavatar_related', blank=True, null=True, to=orm['photologue.PhotoEffect'])),
            ('house', self.gf('django.db.models.fields.related.OneToOneField')(related_name='avatar', unique=True, primary_key=True, to=orm['alpha.House'])),
        ))
        db.send_create_signal('alpha', ['HouseAvatar'])

        # Deleting field 'House.avatar'
        db.delete_column('alpha_house', 'avatar')


    def backwards(self, orm):
        
        # Deleting model 'HouseAvatar'
        db.delete_table('alpha_houseavatar')

        # Adding field 'House.avatar'
        db.add_column('alpha_house', 'avatar', self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100, blank=True), keep_default=False)
    ...
    models = {
        ...
        'alpha.houseavatar': {
            ...
            'effect': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'houseavatar_related'", 'blank': 'True', 'null': 'True', 'to': "orm['photologue.PhotoEffect']"}),
